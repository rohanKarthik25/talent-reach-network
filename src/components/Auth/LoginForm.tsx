  ...
  return <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="flex justify-center bg-zinc-50 mx-0 rounded-none">
            <Briefcase className="h-12 w-12 text-primary" />
          </div>
          <h2 className="mt-6 font-bold text-gray-900 text-6xl">JobPortal</h2>
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-2">
                {demoUsers.map(user => <button key={user.email} onClick={() => {
                setEmail(user.email);
                setPassword('demo123');
            ...
            <div className="mt-6 text-center">
              <span className="text-sm text-gray-600">
                ...
                <button onClick={() => navigate('/register')} className="font-medium text-primary hover:text-primary/80">
                  Sign up
                </button>
              </span>
            </div>
